$(document).ready(function(){
		...
		'<div class="collapse navbar-collapse" id="navbarColor01">'+
			'<ul class="navbar-nav mr-auto">'+
				...
				'</li>'+
				'<li class="nav-item dropdown">'+
					'<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Paquetes</a>'+
					'<div class="dropdown-menu">'+
						'<a class="dropdown-item" href="appointment.php">Agregar servicio</a>'+
					'</div>'+
				'</li>'+
				'<li class="nav-item dropdown">'+
					...
					'<div class="dropdown-menu">'+
						'<a class="dropdown-item" href="patientlist.php">Lista Pacientesd</a>'+
					'</div>'+
				'</li>'+
				'<li class="nav-item dropdown">'+
				'<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Ventas</a>'+
				'<div class="dropdown-menu">'+
					'<a class="dropdown-item" href="ordersList.php">Lista de ventas</a>'+
				'</div>'+
			'</li>'+
			'</ul>'+
